...
function selectionOnClick(info, tab) {
  if (info.selectionText) {
    ...
    var strurl = 'https://translate.google.com.hk/translate_tts?ie=UTF-8&q=' + encodeURIComponent(info.selectionText) + '&tl=' + g_lang + '&total=1&idx=0&textlen=' + info.selectionText.length.toString() + '&prev=input';
